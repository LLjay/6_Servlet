...
public class TotalNote {
	 ...
	 * <div id="rest-review">
      ...
      SELECT COUNT(*)
        ...
        1. 왜 insert delete가 안 되는지
        2. 데이터를 다시 가져와야 할 때, 메소드를 나누는 것 어디서 해줘야 할지
        3. 
        
        객체에 없는 데이터여도 그냥 객체에 이름 지정해서 넣어줘서 서버에서 다른 변수로 저장하면 됨
        
        무한로딩 되면 sql 디벨로퍼에서 데이터를 수정한 후 commit 되지 않은 데이터가 있는 경우가 있음
